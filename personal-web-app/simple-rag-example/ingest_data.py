...
# This file ingests knowledge from the sample-knowledge-base and creates a vector store (assigns meaning)

load_dotenv(override=True)

DB_NAME = str(Path(__file__).parent / "vector_db")
KNOWLEDGE_BASE = str(Path(__file__).parent / "sample-knowledge-base")
...
def create_embeddings(chunks):
    ...
    # create a db from the chunks and persist it to disk
